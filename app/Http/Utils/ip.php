...
//        $lib_curl = new Lib_Curl();
//        $file = $lib_curl->curlGet($url);
...
//        $data = $data['data'];
//        $provice = $data['region'];
//        $provice = str_replace("省","",$provice);
//        $provice = str_replace("市","",$provice);
//        $provice = str_replace("维吾尔自治区","",$provice);
//        $provice = str_replace("回族自治区","",$provice);
//        $provice = str_replace("壮族自治区","",$provice);
//        $provice = str_replace("自治区","",$provice);
//        $city = $data['city'];
...
//            throw new \InvalidArgumentException("The value \"$ip\" is not a valid IP address.");
            return "The value \"$ip\" is not a valid IP address.";
        }
    ...
    private static function init()
    {
        ...
        $reader      = new self();
        $databaseSrc = __DIR__ . '/iplocation/' . $reader->database;
